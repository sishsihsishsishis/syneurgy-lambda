...
const handleStripeWebhook = async (
  ...
  switch (event.type) {
    ...
    case "checkout.session.completed":
      await actions.handleCheckoutSessionCompleted(
        db,
        stripe,
        event,
        user_email,
    ...
    case "customer.subscription.deleted":
      await actions.handleCustomerSubscriptionDeleted(
        db,
        stripe,
        event,
        user_email,
    ...
    case "customer.subscription.updated":
      await actions.handleCustomerSubscriptionUpdated(
        db,
        stripe,
        event,
        user_email,
    ...
    case "invoice.payment_failed":
      await actions.handleInvoicePaymentFailed(
        db,
        stripe,
        event,
        user_email,
    ...
    case "invoice.payment_succeeded":
      await actions.handleInvoicePaymentSucceeded(
        db,
        stripe,
        event,
        user_email,
    ...
    case "payment_intent.succeeded":
      await actions.handlePaymentIntentSucceeded(
        db,
        stripe,
        event,
        user_email,
